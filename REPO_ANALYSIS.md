...
CellSeg1 is a reasonable pilot choice for the P2 QuPath ground truth because it fine-tunes SAM with LoRA from a small annotated image set. Our current P2 export has 35 training tiles and 744 valid cell-boundary instances, each checked to contain one nucleus inside the training tile.
...
- Tiles: 35 exported training tiles
